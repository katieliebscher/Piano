function [playableHand]=DefTotalSubValFunction(handles,hObject,playableHand)
...
for iCnt=1:length(playableHand);
        ...
        playableHand(iCnt).defSubValues=vertOffSubValue+horzOffSubValue+negSlopeOffSubValue+posSlopeOffSubValue;
%         
%         counter=1;
%         for iCnt=1:length(playableHand)
