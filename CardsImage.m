...
% Set Ace Position
A= imread('HA.jpg');
HAPic=imresize(A,[60 NaN]);
handles.R2C6.CData=HAPic;
handles.R5C7.CData=HAPic;


% Set King Position
A = imread('KHearts.jpg');
KHearts=imresize(A,[60 NaN]);
handles.R2C7.CData=KHearts;      
handles.R6C7.CData=KHearts;


% Set Queen Position
A = imread('QHearts.jpg');
QHearts=imresize(A,[60 NaN]);
